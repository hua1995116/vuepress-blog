...
const { algorithm, open, react, vue, node, frontend, debug, op, webpack, interview, canvas, svelte, three, git, grow, news, practice, vscode, aipaint } = require('./algorithm.header')
